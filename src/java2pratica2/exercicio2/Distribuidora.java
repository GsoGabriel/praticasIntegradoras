package java2pratica2.exercicio2;

import java2pratica2.exercicio2.entity.ItemVenda;
import java2pratica2.exercicio2.entity.NaoPereciveis;
import java2pratica2.exercicio2.entity.Pereciveis;
import java2pratica2.exercicio2.entity.Produto;
...
public class Distribuidora {
    public static void main(String[] args) {
        ...
        Produto cafe = new NaoPereciveis("Café", 19.45, "industrializado");
        ...
        itensVenda.add(new ItemVenda(cafe, 1));
